"""Main Scanner Orchestrator for WebRecon - Optimized folder structure."""
...
class WebReconScanner:
    ...
    Uses consolidated folder structure:
    - output/screenshots/ - All screenshots
    - output/results/ - All JSON results
    - output/scan_summary.json - Master summary
    ...
    def __init__(self, config: Optional[Config] = None):
        ...
        self.screenshots_dir = os.path.join(self.config.output_dir, "screenshots")
    ...
    async def _scan_target(
        ...
        async with self._semaphore:
            ...
            self.logger.info(f"Scanning: {hostname}")
            ...
            self.logger.debug(f"Completed: {hostname}")
